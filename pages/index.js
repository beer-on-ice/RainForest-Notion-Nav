    ...
    return (
        <div id="body">
                    ...
                    {databaseContent.results && databaseContent.results.map((page, index) => {
                        return (
                            <a href={page.properties.Website.url} target="_blank" className="card" key={index}>
                                {/* 这里将显示页面名称 */}
                                <img src={page.properties.Icons.files && page.properties.Icons.files[0] && page.properties.Icons.files[0].file && page.properties.Icons.files[0].file.url} className="card-image" alt="图片加载失败" />
            ...
            <footer>
                ...
                <a href="https://github.com/kailous/RainForest-Notion-Nav"><img src="/github.svg" alt="图片加载失败" /></a>
                <p>Notion database nav for RainForest, developed by Kailous.<a href="https://icp.gov.moe/?keyword=20233018" target="_blank">萌ICP备20233018号</a></p>
            </footer>
        </div>
    )
}
